...
The OSI (Open Systems Interconnection) model is a standardised model which we use to demonstrate the theory behind computer networking. In practice, it's actually the more compact TCP/IP model that real world networking is bassed off; however, the OSI model, in many ways, is easier to get an initial understanding from.
